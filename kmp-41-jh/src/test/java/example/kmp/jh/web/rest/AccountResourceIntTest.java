package example.kmp.jh.web.rest;

import example.kmp.jh.config.Constants;
import example.kmp.jh.KmpjhApp;
import example.kmp.jh.domain.Authority;
import example.kmp.jh.domain.User;
import example.kmp.jh.repository.AuthorityRepository;
import example.kmp.jh.repository.UserRepository;
import example.kmp.jh.security.AuthoritiesConstants;
import example.kmp.jh.service.MailService;
import example.kmp.jh.service.dto.UserDTO;
import example.kmp.jh.service.dto.PasswordChangeDTO;
import example.kmp.jh.web.rest.errors.ExceptionTranslator;
import example.kmp.jh.web.rest.vm.KeyAndPasswordVM;
import example.kmp.jh.web.rest.vm.ManagedUserVM;
import example.kmp.jh.service.UserService;
...
@SpringBootTest(classes = KmpjhApp.class)
