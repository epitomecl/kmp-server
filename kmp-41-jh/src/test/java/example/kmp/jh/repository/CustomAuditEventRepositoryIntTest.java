package example.kmp.jh.repository;

import example.kmp.jh.KmpjhApp;
import example.kmp.jh.config.Constants;
import example.kmp.jh.config.audit.AuditEventConverter;
import example.kmp.jh.domain.PersistentAuditEvent;
...
import static example.kmp.jh.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
