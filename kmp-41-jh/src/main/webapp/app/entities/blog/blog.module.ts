...
import { KmpjhAdminModule } from 'app/admin/admin.module';
import {
    BlogComponent,
    BlogDetailComponent,
    BlogUpdateComponent,
...
@NgModule({
    imports: [KmpjhSharedModule, KmpjhAdminModule, RouterModule.forChild(ENTITY_STATES)],
