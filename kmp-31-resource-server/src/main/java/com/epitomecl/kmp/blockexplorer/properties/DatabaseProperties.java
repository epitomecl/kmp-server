package com.epitomecl.kmp.blockexplorer.properties;
...
public class DatabaseProperties {
    ...
    public static final String PREFIX = "datasource.bch-testnet";
    ...
    public String toString() {
        return "DatabaseProperties[" + this.driverClassName + "]";
    }
